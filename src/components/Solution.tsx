    ...
    >
      <div className="section-container">
        ...
        <div className="max-w-3xl mb-16 md:mb-24">
          ...
          >
            No es una escuela partidaria. No es una ONG subsidiaria de ningún
            partido. No es una fundación. Es un espacio impulsado por jóvenes de
            distintos partidos y trayectorias que creen que la política tiene que
            volver a estar en manos de la sociedad.
          </motion.p>
        </div>
