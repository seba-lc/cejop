...
const COOKIE_NAME = "cejop_feedback_e2_done";
...
export default function FeedbackE2Page() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch("/api/feedback-e2", {
        method: "POST",
              ...
              >
                {isIntro ? (
                  ...
                  >
                    ...
                    >
                      Segundo encuentro · CEJOP Tucumán
                    </motion.span>
                    ...
                    <div className="space-y-5 mb-10">
                      ...
                      >
                        <p className="font-source text-[15px] text-white/80 leading-relaxed">
                          Estuviste en el 2do CEJOP — Poder Legislativo. Tu
